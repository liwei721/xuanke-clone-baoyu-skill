...
import { isGenImageSource, materializeGenImageToFile } from "./gen-image.js";
...
export async function resolveImagePath(
  ...
  if (isGenImageSource(imagePath)) {
    return await materializeGenImageToFile(imagePath, tempDir, logLabel);
  }
